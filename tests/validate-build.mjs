...
assert.match(home, /Managing Layer 7 traffic into Uber, Uber’s global DNS infrastructure/);
...
assert.match(home, /Professional service/);
assert.match(home, /Contributing to the systems and networking community/);
